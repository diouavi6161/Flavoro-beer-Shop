...
const Signup = () => {
    ...
    const handleSignup = async(e)=>{
        ...
        const res = await axios.post(`https://beer-shop-backend-3.onrender.com/api/signup`,{name,email,password})
  ...
  return (
    <div className=" flex justify-center items-center h-screen">
      ...
      >
        ...
        <button type="submit" className="outline-none border rounded-md px-3 py-3 text-white bg-green-500 hover:bg-green-300">Signup</button>
